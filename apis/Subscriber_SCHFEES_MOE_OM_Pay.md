# Subscriber/SCHFEES/MOE/OM/Pay

This method will allow a subscriber to pay a to a Government School Fees using his Orange Money account.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `POST` | Allows for a Subscriber to Pay a Government School Fee |

## Endpoint URL

```
/TIMM/v1/Subscriber/SCHFEES/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003//TIMM/v1/Subscriber/SCHFEES/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/SCHFEES/OM/Pay` |
...
| `StudentName` | `String` | ✅ Required | Student Name the school fee is being payed for |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/SCHFEES/OM/Pay" \
