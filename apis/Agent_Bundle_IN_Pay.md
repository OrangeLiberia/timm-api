...
|-----------|-------------|
| `POST` | Allows for an Agent to activate a Bundle and pay through the GSM wallet |

## Endpoint URL

```
TIMM/v1/Agent/Bundle/IN/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Agent/Bundle/IN/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Agent/Bundle/IN/Pay` |
...
| `Wallet` | `EnumString` | ⬜ Optional | Restricted Defines in what Wallet the action should take place: Main, Bonus, Extra Default: Main |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Agent/Bundle/IN/Pay" \
