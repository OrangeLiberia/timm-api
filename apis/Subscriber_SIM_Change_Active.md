...
```
TIMM/v1/Subscriber/SIM/Change/Active
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/SIM/Change/Active` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/SIM/Change/Active` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/SIM/Change/Active" \
