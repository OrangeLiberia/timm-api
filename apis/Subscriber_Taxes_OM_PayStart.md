# Subscriber/Taxes/OM/PayStart

This method will allow a subscriber to pay the Taxes using his Orange Money account. The Subscriber will be notified of the Payment initialization and he will be requested to enter PIN.
