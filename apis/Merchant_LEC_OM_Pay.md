...
This method will allow a Merchant to top up and LEC Meter using the Orange Money merchant account.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Merchant/LEC/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Merchant/LEC/OM/Pay` |
...
| `Amount` | `String` | ✅ Required | Amount to be charged to be Topped up |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Merchant/LEC/OM/Pay" \
