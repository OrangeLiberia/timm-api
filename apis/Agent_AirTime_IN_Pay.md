# Agent/AirTime/IN/Pay

This method will allow an agent to purchase an air time using his GSM account.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Agent/AirTime/IN/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Agent/AirTime/IN/Pay` |
...
| `CURRENCY` | `EnumString` | ✅ Required | Identification of Wallet being charged: - USD |
| `AMOUNT` | `String` | ✅ Required | Amount of air time to charge |
| `WALLET` | `EnumString` | ⬜ Optional | Defines in what Wallet the action should take place: Main Default: Main |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Agent/AirTime/IN/Pay" \
