# Subscriber/BNB/Outbound/OM/Pay

This method will allow a subscriber to pay to one Subscribers using his Orange Money account.
...
```
/TIMM/v1/Subscriber/BNB/Outbound/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003//TIMM/v1/Subscriber/BNB/Outbound/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/BNB/Outbound/OM/Pay` |
...
| `Amount` | `Decimal` | ✅ Required | Amount to be charged to Subscriber PayerPIN OR |
...
| `ExternalID` | `String` | ⬜ Optional | Reference’s to unique id of the caller transaction exec_code integer >= 0 Positive values indicate that method completed with success but encountered |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/BNB/Outbound/OM/Pay" \
