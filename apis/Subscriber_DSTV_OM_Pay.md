# Subscriber/DSTV/OM/Pay

This method will allow a subscriber to pay and activate a DSTV product using his Orange Money account.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `POST` | Allows for a Subscriber to pay a DSTV product |

## Endpoint URL

```
TIMM/v1/Subscriber/DSTV/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/DSTV/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/DSTV/OM/Pay` |
...
| `ExternalID` | `String` | ✅ Required | Reference’s to unique id of the caller transaction Payer’s PIN Payer’s PIN encrypted using public-key cryptography, making use of the certificate of the corresponding platform, and encoded into Base64. (optional) |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/DSTV/OM/Pay" \
