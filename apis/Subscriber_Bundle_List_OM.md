# Subscriber/Bundle/List/OM

This method will allow get information of the Bundles available to be purchase only using the Orange Money wallets.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `GET` | Get Bundles Available to be purchased by a Subscriber using Orange Money Wallet |

## Endpoint URL

```
TIMM/v1/Subscriber/Bundle/List/OM
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/Bundle/List/OM` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Bundle/List/OM` |
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Bundle/List/OM?auth:user=api_user&auth:pwd=api_password&param:MSISDN=0777777588"
```
