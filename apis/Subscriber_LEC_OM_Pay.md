# Subscriber/LEC/OM/Pay

This method will allow a subscriber to top up and LEC Meter using his Orange Money account.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v2/Subscriber/LEC/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v2/Subscriber/LEC/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v2/Subscriber/LEC/OM/Pay" \
