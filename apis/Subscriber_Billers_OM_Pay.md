# Subscriber/Billers/OM/Pay

This method will allow a subscriber to start the payment on the billers. A request is sent to the Orange Money subscriber informing of the charge. Can be used with any Biller not requiring the Biller configuration.
...
```
/TIMM/v1/Subscriber/Billers/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003//TIMM/v1/Subscriber/Billers/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/Billers/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/Billers/OM/Pay" \
