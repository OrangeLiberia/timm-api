# Subscriber/LEC/OM/PayStart

This method will allow a subscriber to top up and LEC Meter using his Orange Money account. The Subscriber will be notified of the Payment initialization and he will be requested to enter PIN.
...
```
TIMM/v1/Subscriber/LEC/OM/PayStart
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/LEC/OM/PayStart` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/LEC/OM/PayStart` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/LEC/OM/PayStart" \
