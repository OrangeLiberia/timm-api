...
This method will allow an agent to top up an LWSC account using his Orange Money account.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `POST` | Allows for a Agent to Pay LWSC |

## Endpoint URL

```
TIMM/v1/Agent/LWSC/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Agent/LWSC/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Agent/LWSC/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Agent/LWSC/OM/Pay" \
