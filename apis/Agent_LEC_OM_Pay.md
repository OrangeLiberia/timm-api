...
This method will allow an agent to top up and LEC Meter using his Orange Money account.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Agent/LEC/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Agent/LEC/OM/Pay` |
...
| `RecipentMSISDN` | `String` | ✅ Required | Recipient Phone Number on whose account the Token should be associated with and will receive the SMS. Phone number can have a size of either 10 or 12 digits, according to the following formats: 077xxxxxx Or 23177xxxxxxx |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Agent/LEC/OM/Pay" \
