# Subscriber/TotalCard/OM/Pay

This method will allow a subscriber to top up a total card using his Orange Money account.
...
```
TIMM/v1/Subscriber/TotalCard/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/TotalCard/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/TotalCard/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/TotalCard/OM/Pay" \
