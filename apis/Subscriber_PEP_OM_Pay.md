# Subscriber/PEP/OM/Pay

This method will allow a subscriber to pay to one or more Subscribers and or Merchants using his Orange Money account.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003//TIMM/v1/Subscriber/PEP/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/PEP/OM/Pay` |
...
| `Identification of Wallet being charged:` | `String` | ✅ Required | USD, LD Amount to be charged to Subscriber Payer’s PIN |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr//TIMM/v1/Subscriber/PEP/OM/Pay" \
  ...
  "param": {
    ...
    "Identification of Wallet being charged:": "ID-001234",
    "Amount": 100.0,
    "TOS": "<TOS>"
  }
}'
