# Subscriber/Bundle/List/IN

This method will allow get information of the Bundles available to be purchase only when using the IN wallet.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `GET` | Get Bundles Available to be purchased by a Subscriber using IN Wallet |

## Endpoint URL

```
TIMM/v1/Subscriber/Bundle/List/IN
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/Bundle/List/IN` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Bundle/List/IN` |
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Bundle/List/IN?auth:user=api_user&auth:pwd=api_password&param:MSISDN=0777777588"
```
