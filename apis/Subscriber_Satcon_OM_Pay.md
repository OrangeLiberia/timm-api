# Subscriber/Satcon/OM/Pay

This method will allow a subscriber to buy a Satcon package using his Orange Money account.
...
```
TIMM/v1/Subscriber/Satcon/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/Satcon/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Satcon/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Satcon/OM/Pay" \
