# CRM/Subscriber/Search/MSISDN

This method can be called to gets the information of the subscriber.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `GET` | Returns the subscriber information |

## Endpoint URL

```
TIMM/v1/CRM/Subscriber/Search/MSISDN
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/CRM/Subscriber/Search/MSISDN` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/CRM/Subscriber/Search/MSISDN` |
...
| `aocument array of IMG` | `Object` | Enum Type of Image: Face, Doc, Contract |
...
```json
{
  ...
  "resultset": {
    ...
    "Status": "Active",
    "aocument array of IMG": "sample_aocument array of IMG",
    "ImgID": 1
  }
}
```
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr/TIMM/v1/CRM/Subscriber/Search/MSISDN?auth:user=api_user&auth:pwd=api_password"
```
