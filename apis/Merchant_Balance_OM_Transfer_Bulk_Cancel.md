# Merchant/Balance/OM/Transfer/Bulk/Cancel
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Merchant/Balance/OM/Transfer/Bulk/Cancel?auth:user=api_user&auth:pwd=api_password"
```
