...
This method provides the Subscriber the Orange Money Balance for a specific Wallet.
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/Balance/OM` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Balance/OM` |
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/Balance/OM?auth:user=api_user&auth:pwd=api_password&param:MSISDN=0777777588&param:Currency=LRD&param:Wallet=<Wallet>"
```
