# Subscriber/AirTime/OM/Pay

This method will allow an agent to purchase an air time using his Subscriber Orange Money account.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `POST` | Allows for a Subscriber to buy airtime and pay through the OM wallet |

## Endpoint URL

```
TIMM/v1/Subscriber/AirTime/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Subscriber/AirTime/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/AirTime/OM/Pay` |
...
| `OMWallet` | `EnumString` | ⬜ Optional | Restricted Defines in what Wallet the action should take place: Main, Comission or Loyalty Default: Main PayerPIN OR |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Subscriber/AirTime/OM/Pay" \
