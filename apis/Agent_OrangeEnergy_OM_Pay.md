# Agent/OrangeEnergy/OM/Pay

This method will allow an agent to top up an Orange Energy account using his Orange Money account.

## Action Definition

| HTTP Verb | Description |
|-----------|-------------|
| `POST` | Allows for a Subscriber to topup an OrangeEnergy account |

## Endpoint URL

```
TIMM/v1/Agent/OrangeEnergy/OM/Pay
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003/TIMM/v1/Agent/OrangeEnergy/OM/Pay` |
| Dev/Test   | `https://APIDEV.Orange.com.lr/TIMM/v1/Agent/OrangeEnergy/OM/Pay` |
...
```bash
curl -k -X POST \
  "https://APIDEV.Orange.com.lr/TIMM/v1/Agent/OrangeEnergy/OM/Pay" \
