...
|-----------|-------------|
| `POST` | Allows for a Subscriber to activate and pay through the OM wallet |
...
| `Currency` | `EnumString` | ✅ Required | Identification of Wallet being charged: - USD, LD PayerPIN OR |
