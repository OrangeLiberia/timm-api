...
|-----------|-------------|
| `GET` | List all the subscribers LEC tokens. |

## Endpoint URL

```
/TIMM/v1/Agent/LEC/Tokens
```
...
|-------------|----------|
| Production | `https://192.168.19.200:11003//TIMM/v1/Agent/LEC/Tokens` |
| Dev/Test   | `https://APIDEV.Orange.com.lr//TIMM/v1/Agent/LEC/Tokens` |
...
```bash
curl -k -X GET \
  "https://APIDEV.Orange.com.lr//TIMM/v1/Agent/LEC/Tokens?auth:user=api_user&auth:pwd=api_password&param:MSISDN=0777777588"
```
